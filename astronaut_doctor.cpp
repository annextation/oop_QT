...
DoctorAstronaut::DoctorAstronaut() : Astronaut() {}

DoctorAstronaut::DoctorAstronaut(wistream& wis) : Astronaut(wis) {
...
DoctorAstronaut::DoctorAstronaut(const std::wstring& name, const std::wstring& country,
